...
<template>
  <div class="globus" v-on:click="int_activity_click">
    <svg class="globus__box d-md-none" width="21.771vw" height="15.104vw">
      <use href="@/assets/img/sprite.svg#globus-box-icon"></use>
    </svg>

    <svg class="d-lg-none" width="29vw" height="17vw" viewBox="0 0 290 171" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="globus__wrapper">
      ...
      <div class="cirlce-block__contains-md d-lg-none">
      ...
      <img class="earth-container-md d-lg-none" src="@/assets/img/globus.svg" alt="">

      <div class="globus__text-contains">
        <div class="globus__text-row">
          <svg class="globus__icon d-md-none" width="5vw" height="0.833vw">
        ...
        <div class="globus__text-row">
          <svg class="globus__icon d-md-none" width="4.792vw" height="0.833vw">
        ...
        <div class="globus__text-row">
          <svg class="globus__icon d-md-none" width="5vw" height="0.573vw">
